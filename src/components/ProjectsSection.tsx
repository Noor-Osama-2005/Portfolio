...
export function ProjectsSection() {
  const projects = [
    ...
    {
      title: "Economic Data Analysis Pipeline",
      description: "Comprehensive analysis of economic indicators using advanced statistical methods and time series forecasting.",
      technologies: ["Python", "Time Series", "Statistical Analysis", "Visualization"],
