              ...
              <CardContent className="p-0">
                <form className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="subject" placeholder="Let's discuss a collaboration" />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      id="message" 
                      placeholder="I'd love to discuss your work in data science and economics..."
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {contactMethods.map((method, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="p-6 hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-card to-background group cursor-pointer">
                    <CardContent className="p-0">
                      <a
                        href={method.link}
